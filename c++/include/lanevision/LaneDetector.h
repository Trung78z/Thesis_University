...
private:
    ...
    cv::Mat getRoiMask();
    std::pair<std::vector<std::pair<double, double>>, std::vector<std::pair<double, double>>> filterLines(const std::vector<cv::Vec4i>& lines);
    std::pair<std::pair<double, double>, double> calculateLane(const std::vector<std::pair<double, double>>& lines, 
                                                              std::deque<std::pair<double, double>>& history, 
                                                              const std::pair<double, double>& prev_lane);
    std::pair<std::pair<double, double>, double> robustLineFit(const std::vector<cv::Point2i>& points);
};